...
- Environment variable `CODEX_CHAT_CMD` to be set to the full CLI command (e.g., `codex exec --model gpt-5-codex -`). The supervisor already pipes prompts through stdin.
