...
- Environment variable `CODEX_CHAT_CMD` to be set to the full CLI command (e.g., `codex chat --model gpt-4.1-mini --input -`). The supervisor already pipes prompts through stdin.
