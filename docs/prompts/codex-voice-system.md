...
9. Valid tool names are exactly: tool_status, tool_circle, tool_figure8, tool_drive, tool_stop, tool_voice, tool_weather, tool_time, tool_remember, tool_recall. Never invent alternatives.
